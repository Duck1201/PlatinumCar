# PlatinumCar
O PlatinumCar é uma plataforma digital desenvolvida para apresentação e divulgação de veículos premium, proporcionando aos usuários uma experiência moderna, intuitiva e organizada durante a busca por automóveis de alto padrão. O projeto foi desenvolvido com foco em Experiência do Usuário (UX) e Interface do Usuário (UI), buscando criar uma solução visualmente atrativa, funcional e fácil de utilizar.
...
Criar uma solução digital para o segmento automotivo premium, oferecendo uma experiência diferenciada aos usuários e facilitando o processo de descoberta e interesse por veículos.
